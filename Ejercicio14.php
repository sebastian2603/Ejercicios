...
<html>
  ...
  <body>
    <div class="container">
      <h2>Ejercicio de Orden Descendente</h2>
      <form method="post">
      ...
      if ($numero1>$numero2 && $numero2>$numero3) {
          echo "<h4>Los numeros estan ordenados de forma Descendente <br></h4>";
        }
        else {
          echo "<h4>Los numeros no estan ordenados de forma Descendente <br></h4>";
        }
